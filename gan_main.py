...
""")
    ...
    # for i in range(1):
    # mod.run(args.nb_epochs, args.w, args.m, args.d, args.label,0,60,args.rd)

    # for i in range(1):
    #     mod.run(args.nb_epochs, args.w, args.m, args.d, args.label,0.1,0,args.rd)
    #
    # for i in range(1):
    #     mod.run(args.nb_epochs, args.w, args.m, args.d, args.label,0.2,0,args.rd)

    for i in range(1):
        mod.run(args.nb_epochs, args.w, args.m, args.d, args.label,0.3,0,args.rd)

    # for i in range(1):
    #     mod.run(args.nb_epochs, args.w, args.m, args.d, args.label,0.4,0,args.rd)

    for i in range(1):
        mod.run(args.nb_epochs, args.w, args.m, args.d, args.label,0.5,0,args.rd)
