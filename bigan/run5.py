...
def train_and_test(nb_epochs, weight, method, degree, random_seed,add_num,ratio):
    ...
    # Data
    trainx, trainy,trainx_a,trainy_a,testx,testy,test_label,test_ip,a_label_train,test_slot_attack,test_slot_desip= data._get_adapted_dataset(ratio)
    ...
    with sv.managed_session() as sess:
        ...
        # nr_batches_train = int(trainx.shape[0] / batch_size)
        # print(str(nr_batches_train) + "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        # nr_batches_test = int(testy.shape[0] / batch_size)
        #
        # ar_batches_train = int(trainx_a.shape[0] / batch_size_a)
        # print(str(ar_batches_train) + "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        # nr_batches_train = min(nr_batches_train, ar_batches_train)
...
def run(nb_epochs, weight, method, degree, label,ratio,add_num, random_seed=42 ):
    """ Runs the training process"""
    with tf.Graph().as_default():
        # tf.reset_default_graph()
        # Set the graph level seed
        tf.set_random_seed(random_seed)
        train_and_test(nb_epochs, weight, method, degree, random_seed,add_num,ratio=ratio)