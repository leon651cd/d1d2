...
def _get_adapted_dataset(ratio):
    ...
    return dataset['x_train'],dataset["y_train"],dataset['x_train_a'],dataset['y_train_a'],dataset['x_test'],dataset['y_test'],dataset['label'],dataset['ip'],dataset['a_label_train'],dataset['slot_attack'],dataset['slot_desip']
